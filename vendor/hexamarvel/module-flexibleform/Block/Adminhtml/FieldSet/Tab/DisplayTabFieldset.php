...
namespace Hexamarvel\FlexibleForm\Block\Adminhtml\FieldSet\Tab;

use Magento\Backend\Block\Widget\Grid\Extended;

class DisplayTabFieldset extends Extended
{
    /**
    ...
    public function getMainButtonsHtml()
    {
        ...
        if ($this->getRequest()->getParam('id', false)) {
            $addUrl = $this->getUrl('hexaform/fieldset/new', ['form_id' => $this->getRequest()->getParam('id', false)]);
    ...
    {
        $collection = $this->_fieldSetFactory->create()->getCollection();
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('class', ['header' => __('Class'), 'index' => 'class']);
    ...
    {
        return $this->getUrl('hexaform/fieldset/tabgrid', ['_current' => true]);
    }
}
