<?php
namespace WeltPixel\Quickview\Block\Adminhtml\QuickviewMessages\Edit\Tab;
...
class Conditions extends Generic implements TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('weltpixel_quickviewmessage');
     ...
     */
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'weltpixelquickview_custommessages_form')
    {
        /** @var \Magento\Framework\Data\Form $form */
