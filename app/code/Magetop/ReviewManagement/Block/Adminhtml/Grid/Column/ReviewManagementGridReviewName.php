...
class ReviewManagementGridReviewName extends AbstractRenderer
{
    /**
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $cell = '<a href="' . $this->_objectmanager->create('Magento\Backend\Helper\Data')->getUrl('review/product/edit',['id' => $review->getId()]) . '" onclick="this.target=\'blank\'">' . $review->getTitle() . '</a>';
        return $cell;
    }
}