...
use Mageplaza\GdprPro\Model\ResourceModel\DownloadLogs\Collection;
use Mageplaza\GdprPro\Model\ResourceModel\DownloadLogs\CollectionFactory;

/**
 * Class AbstractDownloadLog
 * @package Mageplaza\GdprPro\Controller\Adminhtml
 */
abstract class AbstractDownloadLog extends Action
{
    /**
     * Authorization level of a basic admin session
     */
    const ADMIN_RESOURCE = 'Mageplaza_GdprPro::download_log';
