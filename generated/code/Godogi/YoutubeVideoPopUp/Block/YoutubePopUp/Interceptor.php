<?php
namespace Godogi\YoutubeVideoPopUp\Block\YoutubePopUp;

/**
 * Interceptor class for @see \Godogi\YoutubeVideoPopUp\Block\YoutubePopUp
 */
class Interceptor extends \Godogi\YoutubeVideoPopUp\Block\YoutubePopUp implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductName()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getProductName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getYoutubeVideos');
        if (!$pluginInfo) {
            return parent::getYoutubeVideos();
        } else {
            return $this->___callPlugins('getYoutubeVideos', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPdfLinks');
        if (!$pluginInfo) {
            return parent::getPdfLinks();
        } else {
            return $this->___callPlugins('getPdfLinks', func_get_args(), $pluginInfo);
        }
    }
