...
class Interceptor extends \Magento\Shipping\Block\Adminhtml\Order\Packaging implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShipment');
        if (!$pluginInfo) {
            return parent::getShipment();
        } else {
            return $this->___callPlugins('getShipment', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigDataJson');
        if (!$pluginInfo) {
            return parent::getConfigDataJson();
        } else {
            return $this->___callPlugins('getConfigDataJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContainerTypeByCode');
        if (!$pluginInfo) {
            return parent::getContainerTypeByCode($code);
        } else {
            return $this->___callPlugins('getContainerTypeByCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeliveryConfirmationTypeByCode');
        if (!$pluginInfo) {
            return parent::getDeliveryConfirmationTypeByCode($code);
        } else {
            return $this->___callPlugins('getDeliveryConfirmationTypeByCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentTypeByCode');
        if (!$pluginInfo) {
            return parent::getContentTypeByCode($code);
        } else {
            return $this->___callPlugins('getContentTypeByCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPackages');
        if (!$pluginInfo) {
            return parent::getPackages();
        } else {
            return $this->___callPlugins('getPackages', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShipmentItem');
        if (!$pluginInfo) {
            return parent::getShipmentItem($itemId, $itemsOf);
        } else {
            return $this->___callPlugins('getShipmentItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayCustomsValue');
        if (!$pluginInfo) {
            return parent::displayCustomsValue();
        } else {
            return $this->___callPlugins('displayCustomsValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPrintButton');
        if (!$pluginInfo) {
            return parent::getPrintButton();
        } else {
            return $this->___callPlugins('getPrintButton', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomValueCurrencyCode');
        if (!$pluginInfo) {
            return parent::getCustomValueCurrencyCode();
        } else {
            return $this->___callPlugins('getCustomValueCurrencyCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayPrice');
        if (!$pluginInfo) {
            return parent::displayPrice($price);
        } else {
            return $this->___callPlugins('displayPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'displayCustomsPrice');
        if (!$pluginInfo) {
            return parent::displayCustomsPrice($price);
        } else {
            return $this->___callPlugins('displayCustomsPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getQtyOrderedItem');
        if (!$pluginInfo) {
            return parent::getQtyOrderedItem($itemId);
        } else {
            return $this->___callPlugins('getQtyOrderedItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSourceSizeModel');
        if (!$pluginInfo) {
            return parent::getSourceSizeModel();
        } else {
            return $this->___callPlugins('getSourceSizeModel', func_get_args(), $pluginInfo);
        }
    }
