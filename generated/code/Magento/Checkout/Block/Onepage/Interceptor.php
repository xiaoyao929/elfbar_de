...
class Interceptor extends \Magento\Checkout\Block\Onepage implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCheckoutConfig');
        if (!$pluginInfo) {
            return parent::getCheckoutConfig();
        } else {
            return $this->___callPlugins('getCheckoutConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSerializedCheckoutConfig');
        if (!$pluginInfo) {
            return parent::getSerializedCheckoutConfig();
        } else {
            return $this->___callPlugins('getSerializedCheckoutConfig', func_get_args(), $pluginInfo);
        }
    }
