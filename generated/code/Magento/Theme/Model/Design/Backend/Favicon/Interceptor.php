<?php
namespace Magento\Theme\Model\Design\Backend\Favicon;

/**
 * Interceptor class for @see \Magento\Theme\Model\Design\Backend\Favicon
 */
class Interceptor extends \Magento\Theme\Model\Design\Backend\Favicon implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAllowedExtension');
        if (!$pluginInfo) {
            return parent::isAllowedExtension($extension);
        } else {
            return $this->___callPlugins('isAllowedExtension', func_get_args(), $pluginInfo);
        }
    }
