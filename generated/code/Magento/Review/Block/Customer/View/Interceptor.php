...
class Interceptor extends \Magento\Review\Block\Customer\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductData');
        if (!$pluginInfo) {
            return parent::getProductData();
        } else {
            return $this->___callPlugins('getProductData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRating');
        if (!$pluginInfo) {
            return parent::getRating();
        } else {
            return $this->___callPlugins('getRating', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRatingSummary()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getRatingSummary', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'dateFormat');
        if (!$pluginInfo) {
            return parent::dateFormat($date);
        } else {
            return $this->___callPlugins('dateFormat', func_get_args(), $pluginInfo);
        }
    }
