...
class Interceptor extends \Magento\Cms\Block\Adminhtml\Wysiwyg\Images\Content implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getContentsUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getContentsUrl();
        } else {
            return $this->___callPlugins('getContentsUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getNewfolderUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getNewfolderUrl();
        } else {
            return $this->___callPlugins('getNewfolderUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getDeleteFilesUrl()
    {
        ...
        if (!$pluginInfo) {
            return parent::getDeleteFilesUrl();
        } else {
            return $this->___callPlugins('getDeleteFilesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getTargetElementId()
    {
        ...
        if (!$pluginInfo) {
            return parent::getTargetElementId();
        } else {
            return $this->___callPlugins('getTargetElementId', func_get_args(), $pluginInfo);
        }
    }
