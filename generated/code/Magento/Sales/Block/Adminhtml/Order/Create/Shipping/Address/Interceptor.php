...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Shipping\Address implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsShipping');
        if (!$pluginInfo) {
            return parent::getIsShipping();
        } else {
            return $this->___callPlugins('getIsShipping', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsAsBilling');
        if (!$pluginInfo) {
            return parent::getIsAsBilling();
        } else {
            return $this->___callPlugins('getIsAsBilling', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDontSaveInAddressBook');
        if (!$pluginInfo) {
            return parent::getDontSaveInAddressBook();
        } else {
            return $this->___callPlugins('getDontSaveInAddressBook', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAddressId()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getAddressId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getIsDisabled');
        if (!$pluginInfo) {
            return parent::getIsDisabled();
        } else {
            return $this->___callPlugins('getIsDisabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAddressCollectionJson()
    {
        ...
        if (!$pluginInfo) {
            return parent::getAddressCollectionJson();
        } else {
            return $this->___callPlugins('getAddressCollectionJson', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getAddressAsString(\Magento\Customer\Api\Data\AddressInterface $address)
    {
        ...
        if (!$pluginInfo) {
            return parent::getAddressAsString($address);
        } else {
            return $this->___callPlugins('getAddressAsString', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getItemPrice(\Magento\Catalog\Model\Product $product)
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemPrice($product);
        } else {
