...
class Interceptor extends \Magento\Sales\Block\Adminhtml\Order\Create\Messages implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setMessages(\Magento\Framework\Message\Collection $messages)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setMessages', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addMessages(\Magento\Framework\Message\Collection $messages)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addMessages', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addWarning($message)
    {
        ...
        if (!$pluginInfo) {
            return parent::addWarning($message);
        } else {
            return $this->___callPlugins('addWarning', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addNotice($message)
    {
        ...
        if (!$pluginInfo) {
            return parent::addNotice($message);
        } else {
            return $this->___callPlugins('addNotice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addSuccess($message)
    {
        ...
        if (!$pluginInfo) {
            return parent::addSuccess($message);
        } else {
            return $this->___callPlugins('addSuccess', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMessagesByType($type)
    {
        ...
        if (!$pluginInfo) {
            return parent::getMessagesByType($type);
        } else {
            return $this->___callPlugins('getMessagesByType', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMessageTypes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMessageTypes();
        } else {
            return $this->___callPlugins('getMessageTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getGroupedHtml()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getGroupedHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFirstLevelTagName($tagName)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFirstLevelTagName($tagName);
        } else {
            return $this->___callPlugins('setFirstLevelTagName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setSecondLevelTagName($tagName)
    {
        ...
        if (!$pluginInfo) {
            return parent::setSecondLevelTagName($tagName);
        } else {
            return $this->___callPlugins('setSecondLevelTagName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addStorageType($type)
    {
        ...
        if (!$pluginInfo) {
            return parent::addStorageType($type);
        } else {
            return $this->___callPlugins('addStorageType', func_get_args(), $pluginInfo);
        }
    }
