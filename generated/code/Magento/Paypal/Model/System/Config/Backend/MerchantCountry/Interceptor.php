<?php
namespace Magento\Paypal\Model\System\Config\Backend\MerchantCountry;

/**
 * Interceptor class for @see \Magento\Paypal\Model\System\Config\Backend\MerchantCountry
 */
class Interceptor extends \Magento\Paypal\Model\System\Config\Backend\MerchantCountry implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $storeManager, $directoryHelper, $resource, $resourceCollection, $data);
    }
