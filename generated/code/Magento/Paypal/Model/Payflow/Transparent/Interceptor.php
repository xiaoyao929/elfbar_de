...
class Interceptor extends \Magento\Paypal\Model\Payflow\Transparent implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getResponceValidator');
        if (!$pluginInfo) {
            return parent::getResponceValidator();
        } else {
            return $this->___callPlugins('getResponceValidator', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getConfigInterface');
        if (!$pluginInfo) {
            return parent::getConfigInterface();
        } else {
            return $this->___callPlugins('getConfigInterface', func_get_args(), $pluginInfo);
        }
    }
