<?php
namespace Magento\Catalog\Model\System\Config\Backend\Catalog\Url\Rewrite\Suffix;

/**
 * Interceptor class for @see \Magento\Catalog\Model\System\Config\Backend\Catalog\Url\Rewrite\Suffix
 */
class Interceptor extends \Magento\Catalog\Model\System\Config\Backend\Catalog\Url\Rewrite\Suffix implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($context, $registry, $config, $cacheTypeList, $urlRewriteHelper, $storeManager, $appResource, $urlFinder, $resource, $resourceCollection, $data);
    }
