...
class Interceptor extends \Magento\Multishipping\Block\Checkout\Shipping implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressCount');
        if (!$pluginInfo) {
            return parent::getAddressCount();
        } else {
            return $this->___callPlugins('getAddressCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressItems');
        if (!$pluginInfo) {
            return parent::getAddressItems($address);
        } else {
            return $this->___callPlugins('getAddressItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressShippingMethod');
        if (!$pluginInfo) {
            return parent::getAddressShippingMethod($address);
        } else {
            return $this->___callPlugins('getAddressShippingMethod', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingRates');
        if (!$pluginInfo) {
            return parent::getShippingRates($address);
        } else {
            return $this->___callPlugins('getShippingRates', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCarrierName');
        if (!$pluginInfo) {
            return parent::getCarrierName($carrierCode);
        } else {
            return $this->___callPlugins('getCarrierName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddressEditUrl');
        if (!$pluginInfo) {
            return parent::getAddressEditUrl($address);
        } else {
            return $this->___callPlugins('getAddressEditUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getItemsEditUrl');
        if (!$pluginInfo) {
            return parent::getItemsEditUrl();
        } else {
            return $this->___callPlugins('getItemsEditUrl', func_get_args(), $pluginInfo);
        }
    }
