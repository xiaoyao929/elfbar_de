...
class Interceptor extends \Magento\Newsletter\Model\Queue\TransportBuilder implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setTemplateData');
        if (!$pluginInfo) {
            return parent::setTemplateData($data);
        } else {
            return $this->___callPlugins('setTemplateData', func_get_args(), $pluginInfo);
        }
    }
