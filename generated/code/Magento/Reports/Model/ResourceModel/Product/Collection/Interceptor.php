...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSelectCountSqlType');
        if (!$pluginInfo) {
            return parent::setSelectCountSqlType($type);
        } else {
            return $this->___callPlugins('setSelectCountSqlType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductEntityId');
        if (!$pluginInfo) {
            return parent::setProductEntityId($entityId);
        } else {
            return $this->___callPlugins('setProductEntityId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductEntityId');
        if (!$pluginInfo) {
            return parent::getProductEntityId();
        } else {
            return $this->___callPlugins('getProductEntityId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductEntityTableName');
        if (!$pluginInfo) {
            return parent::setProductEntityTableName($value);
        } else {
            return $this->___callPlugins('setProductEntityTableName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductEntityTableName');
        if (!$pluginInfo) {
            return parent::getProductEntityTableName();
        } else {
            return $this->___callPlugins('getProductEntityTableName', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductAttributeSetId');
        if (!$pluginInfo) {
            return parent::getProductAttributeSetId();
        } else {
            return $this->___callPlugins('getProductAttributeSetId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setProductAttributeSetId');
        if (!$pluginInfo) {
            return parent::setProductAttributeSetId($value);
        } else {
            return $this->___callPlugins('setProductAttributeSetId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStoreRestrictions');
        if (!$pluginInfo) {
            return parent::addStoreRestrictions($storeIds, $websiteIds);
        } else {
            return $this->___callPlugins('addStoreRestrictions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isAttributeAdded($attributeCode) : bool
    {
        ...
        if (!$pluginInfo) {
            return parent::isAttributeAdded($attributeCode);
        } else {
            return $this->___callPlugins('isAttributeAdded', func_get_args(), $pluginInfo);
        }
    }
