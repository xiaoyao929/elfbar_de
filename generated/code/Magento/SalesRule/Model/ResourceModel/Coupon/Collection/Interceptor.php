...
class Interceptor extends \Magento\SalesRule\Model\ResourceModel\Coupon\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRuleToFilter');
        if (!$pluginInfo) {
            return parent::addRuleToFilter($rule);
        } else {
            return $this->___callPlugins('addRuleToFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRuleIdsToFilter');
        if (!$pluginInfo) {
            return parent::addRuleIdsToFilter($ruleIds);
        } else {
            return $this->___callPlugins('addRuleIdsToFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addGeneratedCouponsFilter');
        if (!$pluginInfo) {
            return parent::addGeneratedCouponsFilter();
        } else {
            return $this->___callPlugins('addGeneratedCouponsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsUsedFilterCallback');
        if (!$pluginInfo) {
            return parent::addIsUsedFilterCallback($collection, $column);
        } else {
            return $this->___callPlugins('addIsUsedFilterCallback', func_get_args(), $pluginInfo);
        }
    }
