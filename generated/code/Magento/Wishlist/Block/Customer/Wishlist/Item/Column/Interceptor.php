...
class Interceptor extends \Magento\Wishlist\Block\Customer\Wishlist\Item\Column implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFormattedDate');
        if (!$pluginInfo) {
            return parent::getFormattedDate($date);
        } else {
            return $this->___callPlugins('getFormattedDate', func_get_args(), $pluginInfo);
        }
    }
