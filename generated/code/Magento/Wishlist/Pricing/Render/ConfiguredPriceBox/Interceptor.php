...
class Interceptor extends \Magento\Wishlist\Pricing\Render\ConfiguredPriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getConfiguredPrice() : \Magento\Framework\Pricing\Price\PriceInterface
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfiguredPrice();
        } else {
            return $this->___callPlugins('getConfiguredPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getConfiguredRegularPrice() : \Magento\Framework\Pricing\Price\PriceInterface
    {
        ...
        if (!$pluginInfo) {
            return parent::getConfiguredRegularPrice();
        } else {
            return $this->___callPlugins('getConfiguredRegularPrice', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isProductList()
    {
        ...
        if (!$pluginInfo) {
            return parent::isProductList();
        } else {
            return $this->___callPlugins('isProductList', func_get_args(), $pluginInfo);
        }
    }
