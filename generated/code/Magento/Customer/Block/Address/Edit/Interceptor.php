...
class Interceptor extends \Magento\Customer\Block\Address\Edit implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCustomerAddressCount');
        if (!$pluginInfo) {
            return parent::getCustomerAddressCount();
        } else {
            return $this->___callPlugins('getCustomerAddressCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canSetAsDefaultBilling');
        if (!$pluginInfo) {
            return parent::canSetAsDefaultBilling();
        } else {
            return $this->___callPlugins('canSetAsDefaultBilling', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canSetAsDefaultShipping');
        if (!$pluginInfo) {
            return parent::canSetAsDefaultShipping();
        } else {
            return $this->___callPlugins('canSetAsDefaultShipping', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBackButtonUrl');
        if (!$pluginInfo) {
            return parent::getBackButtonUrl();
        } else {
            return $this->___callPlugins('getBackButtonUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadrRegionUrl');
        if (!$pluginInfo) {
            return parent::getLoadrRegionUrl();
        } else {
            return $this->___callPlugins('getLoadrRegionUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCountryCollection');
        if (!$pluginInfo) {
            return parent::getCountryCollection();
        } else {
            return $this->___callPlugins('getCountryCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCountryHtmlSelect');
        if (!$pluginInfo) {
            return parent::getCountryHtmlSelect($defValue, $name, $id, $title);
        } else {
            return $this->___callPlugins('getCountryHtmlSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegionCollection');
        if (!$pluginInfo) {
            return parent::getRegionCollection();
        } else {
            return $this->___callPlugins('getRegionCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegionHtmlSelect');
        if (!$pluginInfo) {
            return parent::getRegionHtmlSelect();
        } else {
            return $this->___callPlugins('getRegionHtmlSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegionSelect');
        if (!$pluginInfo) {
            return parent::getRegionSelect($value, $name, $id, $title);
        } else {
            return $this->___callPlugins('getRegionSelect', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegionsJs');
        if (!$pluginInfo) {
            return parent::getRegionsJs();
        } else {
            return $this->___callPlugins('getRegionsJs', func_get_args(), $pluginInfo);
        }
    }
