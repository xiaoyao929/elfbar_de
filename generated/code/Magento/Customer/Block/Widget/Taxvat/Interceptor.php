...
class Interceptor extends \Magento\Customer\Block\Widget\Taxvat implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isRequired');
        if (!$pluginInfo) {
            return parent::isRequired();
        } else {
            return $this->___callPlugins('isRequired', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreLabel($attributeCode)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreLabel($attributeCode);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldIdFormat');
        if (!$pluginInfo) {
            return parent::getFieldIdFormat();
        } else {
            return $this->___callPlugins('getFieldIdFormat', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldNameFormat');
        if (!$pluginInfo) {
            return parent::getFieldNameFormat();
        } else {
            return $this->___callPlugins('getFieldNameFormat', func_get_args(), $pluginInfo);
        }
    }
