...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Visitor implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fetchCreatedAt');
        if (!$pluginInfo) {
            return parent::fetchCreatedAt($visitorId);
        } else {
            return $this->___callPlugins('fetchCreatedAt', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateCreatedAt');
        if (!$pluginInfo) {
            parent::updateCreatedAt($visitorId, $timestamp);
        } else {
            $this->___callPlugins('updateCreatedAt', func_get_args(), $pluginInfo);
        }
    }
