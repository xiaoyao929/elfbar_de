...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Customer implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function loadByEmail(\Magento\Customer\Model\Customer $customer, $email)
    {
        ...
        if (!$pluginInfo) {
            return parent::loadByEmail($customer, $email);
        } else {
    ...
    public function findEmailDuplicates()
    {
        ...
        if (!$pluginInfo) {
            return parent::findEmailDuplicates();
        } else {
            return $this->___callPlugins('findEmailDuplicates', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getWebsiteId($customerId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getWebsiteId($customerId);
        } else {
    ...
    public function findSessionCutOff(int $customerId) : ?int
    {
        ...
        if (!$pluginInfo) {
            return parent::findSessionCutOff($customerId);
        } else {
            return $this->___callPlugins('findSessionCutOff', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function updateSessionCutOff(int $customerId, int $timestamp) : void
    {
        ...
        if (!$pluginInfo) {
            parent::updateSessionCutOff($customerId, $timestamp);
        } else {
            $this->___callPlugins('updateSessionCutOff', func_get_args(), $pluginInfo);
        }
    }
