...
class Interceptor extends \Magento\Customer\Controller\Ajax\Login implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setAccountRedirect($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAccountRedirect($value);
        } else {
            return $this->___callPlugins('setAccountRedirect', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setScopeConfig($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::setScopeConfig($value);
        } else {
            return $this->___callPlugins('setScopeConfig', func_get_args(), $pluginInfo);
        }
    }
