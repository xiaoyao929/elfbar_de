...
class Interceptor extends \Magento\Customer\Controller\Account\Logout implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Framework\App\Action\Context $context, \Magento\Customer\Model\Session $customerSession, ?\Magento\Customer\Api\SessionCleanerInterface $sessionCleaner = null)
    {
        $this->___init();
        parent::__construct($context, $customerSession, $sessionCleaner);
    }
