<?php
namespace Mageplaza\Gdpr\Block\Address\Account;

/**
 * Interceptor class for @see \Mageplaza\Gdpr\Block\Address\Account
 */
class Interceptor extends \Mageplaza\Gdpr\Block\Address\Account implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Mageplaza\Gdpr\Helper\Data $helperData, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeleteAccountMessage');
        if (!$pluginInfo) {
            return parent::getDeleteAccountMessage();
        } else {
            return $this->___callPlugins('getDeleteAccountMessage', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'allowDeleteAccount');
        if (!$pluginInfo) {
            return parent::allowDeleteAccount();
        } else {
            return $this->___callPlugins('allowDeleteAccount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExtraData');
        if (!$pluginInfo) {
            return parent::getExtraData();
        } else {
            return $this->___callPlugins('getExtraData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDeleteAccountUrl');
        if (!$pluginInfo) {
            return parent::getDeleteAccountUrl();
        } else {
            return $this->___callPlugins('getDeleteAccountUrl', func_get_args(), $pluginInfo);
        }
    }
