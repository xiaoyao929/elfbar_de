...
class Interceptor extends \Mageplaza\LayeredNavigation\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCollectionClone($isReturn = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCollectionClone($isReturn);
        } else {
            return $this->___callPlugins('getCollectionClone', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function removeAttributeSearch($attributeCode)
    {
        ...
        if (!$pluginInfo) {
            return parent::removeAttributeSearch($attributeCode);
        } else {
            return $this->___callPlugins('removeAttributeSearch', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addLayerCategoryFilter($categories)
    {
        ...
        if (!$pluginInfo) {
            return parent::addLayerCategoryFilter($categories);
        } else {
            return $this->___callPlugins('addLayerCategoryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function resetCategoryFilter($categoryIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::resetCategoryFilter($categoryIds);
        } else {
            return $this->___callPlugins('resetCategoryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCategoryFilter($categoryIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCategoryFilter($categoryIds);
        } else {
            return $this->___callPlugins('setCategoryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function resetCategoryIds($categoryIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::resetCategoryIds($categoryIds);
        } else {
            return $this->___callPlugins('resetCategoryIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function resetTotalRecords()
    {
        ...
        if (!$pluginInfo) {
            return parent::resetTotalRecords();
        } else {
            return $this->___callPlugins('resetTotalRecords', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setGetAllData($isGetAll)
    {
        ...
        if (!$pluginInfo) {
            return parent::setGetAllData($isGetAll);
        } else {
            return $this->___callPlugins('setGetAllData', func_get_args(), $pluginInfo);
        }
    }
