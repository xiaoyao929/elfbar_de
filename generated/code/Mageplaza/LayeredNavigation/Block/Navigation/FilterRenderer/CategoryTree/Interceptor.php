...
class Interceptor extends \Mageplaza\LayeredNavigation\Block\Navigation\FilterRenderer\CategoryTree implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryTreeHtml');
        if (!$pluginInfo) {
            return parent::getCategoryTreeHtml($filter);
        } else {
            return $this->___callPlugins('getCategoryTreeHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setFilter');
        if (!$pluginInfo) {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isAutoExpand');
        if (!$pluginInfo) {
            return parent::isAutoExpand();
        } else {
            return $this->___callPlugins('isAutoExpand', func_get_args(), $pluginInfo);
        }
    }
